...
<head>
<meta charset="UTF-8">
<title>예약등록 정보 확인</title>
   <meta charset="UTF-8">
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <title>Document</title>
   <link rel="stylesheet" type="text/css" href="${contextPath }/resources/css/reserve/reserveInfoForm.css">
   ...
   <script>
      ...
      /*
	   ...
	   reserveDate
	   reservePrice
	   usingTime > 000001100 같은 문자열
	   extraCode > 신경쓸거없음
	}
	> paymentInfo {
	   usingTime > 사용시간 문자열로 바꾼거(00:00 ~ 12:00)
	   roomName
	   scale
	   userName
	   userTel1
    ...
    function submitAction(){
 		...
 		var result = confirm(reserveDate + " " + reserveInfo + " 의 결제금액은 " + priceDate +"원 입니다. 정말로 대실하시겠습니까 ? ");
 		if(!result){
 			alert("예약이 취소되었습니다.");
 			history.back(-1);
 			return;
 		...
 		var reserve = {
 			...
 			'centerCode' : '${reserve.centerCode}',
 			'roomCode' : '${reserve.roomCode}',
 			'reserveDate' : '${reserve.reserveDate}',
 			'usingTime' : '${reserve.usingTime}',
 			'extraCode' : '0'
 		...
 		$.ajax({
 			...
 			dataType:'text',
 			data:{
 				'reservePrice':priceDate,
 				'reserve':JSON.stringify(reserve)
 			},
 			success:function(data,textStatus){
 				if(data == 'true'){
 					alert("예약이 정상적으로 처리되었습니다. 감사합니다.")
 					location.href="${contextPath}/reserve/listReserveBefore.do"
 				}else{
 					alert("알 수 없는 오류로 예약에 실패했습니다. 잠시 후 다시 시도해 주세요.")
 				}
 			},
...
<div class="mContent_wrap">
    ...
    <div class="reserveInfoFormWrap">
    <div class="width_wrap">
    
    
    
    <div class="block_wrap reserveInfoWrap">
    	<div class="infoTitle">
    		<p>
    	...
    	<ul class="reserveInfo">
    		<li>
    		
    			<dl>
    				<dt><strong>일정</strong></dt>
    				<dd><p class="green">${reserveInfo.reserveDate }(화요일)<b> ${paymentInfo.usingTime } </b></p></dd>
    			</dl>
    		</li>
    		<li>
    			<dl>
    				<dt><strong>상품</strong></dt>
    				<dd><p class="green"><b>${paymentInfo.centerName }</b>(${paymentInfo.roomName }) - <span class="gray">${paymentInfo.scale }인실</span></p></dd>
    			</dl>
    		</li>
    		<li>
    			<dl>
    				<dt><strong>주소</strong></dt>
    				<dd><p class="green">${paymentInfo.centerAdd1 } ${paymentInfo.centerAdd2 } ${paymentInfo.centerAdd3 }</p></dd>
    			</dl>
    		</li>
    	</ul>
    </div>
    	...
    	<div class="block_title">
    		<h3>이용약관</h3>
    			<div class="privacy_chk">
	    			<p class="designCheck">
	    				<input type="checkbox" id="tos_chk" name="tos"><label for="tos_chk"><span></span><b>동의합니다.</b></label>
	    			</p>
	   			</div>
	  		</div>
    	<div class="txt_box">
...
<li>						④ 본 이용 계약이 해지된 경우 회원의 쪽지, 마이피와 같이 본인 개인 영역에 등록된 ‘쪽지글, 게시글 등’ 일체는 삭제됩니다만 다른 회원에 의해 스크랩되어 게시되거나 공용 게시판에 등록된 ‘게시물 등’은 삭제되지 않습니다.</li>
    	...
    	<div class="block_title">
    		<h3>개인정보 수집 및 동의</h3>
   			<div class="privacy_chk">
	    		<p class="designCheck">
					<input type="checkbox" id="privacy_chk" name="privacy"><label for="privacy_chk"><span></span><b>동의합니다.</b></label>
				</p>
			</div>		
    	</div>
    	<div class="txt_box">
...
<li>						④ 본 이용 계약이 해지된 경우 회원의 쪽지, 마이피와 같이 본인 개인 영역에 등록된 ‘쪽지글, 게시글 등’ 일체는 삭제됩니다만 다른 회원에 의해 스크랩되어 게시되거나 공용 게시판에 등록된 ‘게시물 등’은 삭제되지 않습니다.</li>
    ...
    <div class="block_wrap">
	    ...
	    <form name="reserveInfoForm" id="reserveInfoForm"  action="#" method="post">
	        <fieldset>
	            <ul class="reserveUserList clear_both">
	                <li class="">
	                    <p>
	                        <strong>예약자<span class="required">*</span></strong>
	                        <input required type="text" name="userName" id="userName" readonly value="${paymentInfo.userName }">
	                    </p>
	                </li>
	                <li class="">
	                    <p>
	                        ...
	                        <input required type="text" readonly name="userTel2" class="telNum" maxlength="4" minlength="3" id="userTel1" value="${paymentInfo.userTel1 }">
	                        <input required type="text" readonly name="userTel2" class="telNum" maxlength="4" minlength="3" id="userTel2" value="${paymentInfo.userTel2 }">
	                        <input required type="text" readonly name="userTel3" class="telNum" maxlength="4" minlength="4" id="userTel3" value="${paymentInfo.userTel3 }">
	                    </p>
	                </li>
	                <li class="">
	                    <p>
	                        <strong>이메일</strong>
	                        <input required  type="text" readonly name="userEmail" id="userEmail" value="${paymentInfo.userEmail }">
	                    </p>
	                </li>
	            </ul>
	        </fieldset>
           ...
           <ul class="reserveUserList clear_both">
               <li class="priceInfo">
                   <p>
                       <strong>결제 상품</strong>
                       <span>
                       	<i class="pdt_info">${reserve.reserveDate } (${paymentInfo.usingTime }) </i>
                       	<i class="pdt_info">${paymentInfo.centerName } (${paymentInfo.roomName }) </i>
                       	<span class="price"><fmt:formatNumber value="${reserve.reservePrice }" pattern="#,###" /><b>원</b></span>
                       </span>
               ...
               <li>
               	<p class="clear_both">
                       <input class="btn_type_03 submitBtn float_right" type="button" onclick="submitAction()" value="예약하기">
                       <input class="btn_type_03 resetBtn float_left" type="button" value="취소" onclick="history.back()">
                   </p> 
              </li>
           </ul>
    </div>
